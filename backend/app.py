...
documents_data = [
    ...
    {"title": "Doc 3", "content": "Un altro esempio di documento con contenuto interessante..."},
]
...
def generate_ai_response(query: str) -> str:
    return f"Certo che conosco {query}, è una realtà fighissima! Lascia che ti spieghi meglio..."
